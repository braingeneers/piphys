...
public:
    ...
    int getSampleRate(int mux, int adcBuffer);
    ...
    int createCommandListRegisterConfig(vector<uint16_t> &commandList, bool calibrate);
    int createCommandListTempSensor(vector<uint16_t> &commandList);
    int createCommandListUpdateDigOut(vector<uint16_t> &commandList);
    int createCommandListZcheckDac(vector<uint16_t> &commandList, double frequency, double amplitude);
    int createCommandListConvert(vector<uint16_t> &commandList);
    int createCommandListDummy(vector <uint16_t> &commandList);
    int createCommandListDummy(vector <uint16_t> &commandList, int n);
    int createCommandListDummy(vector <uint16_t> &commandList, int n, unsigned int cmd);
    int orderEndianCommandList(vector<uint16_t> &commandList);
