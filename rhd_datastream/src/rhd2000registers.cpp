...
// Version 1.5.3 (26 August 2019)
//
// Copyright (c) 2013-2019 Intan Technologies LLC
//
...
Rhd2000Registers::Rhd2000Registers(double sampleRate)
{
    ...
    twosComp = 1;               // two's complement ADC results (0 = unsigned offset representation; 1 = signed
                                // representation)
...
// Use the muxBias and adcBufferBias to determine sample rate per channel
int Rhd2000Registers::getSampleRate(int adcBuffer, int mux)
{
    int sampleRateChannel;
    if (mux == 40 && adcBuffer == 32) {
        sampleRateChannel = 3333;
    } else if (mux == 40 && adcBuffer == 16) {
        sampleRateChannel = 4000;
    } else if (mux == 40 && adcBuffer == 8) {
        sampleRateChannel = 5000;
    } else if (mux == 32 && adcBuffer == 8) {
        sampleRateChannel = 6250;
    } else if (mux == 26 && adcBuffer == 8) {
        sampleRateChannel = 8000;
    } else if (mux == 18 && adcBuffer == 4) {
        sampleRateChannel = 10000;
    } else if (mux == 16 && adcBuffer == 3) {
        sampleRateChannel = 12500;
    } else if (mux == 7 && adcBuffer == 3) {
        sampleRateChannel = 15000;
    } else if (mux == 4 && adcBuffer == 2) {
        sampleRateChannel = 20000;;
    } else {
        sampleRateChannel = 0;
    }
    
    return sampleRateChannel;
}
...
int Rhd2000Registers::createCommandListRegisterConfig(vector<uint16_t> &commandList, bool calibrate)
{
...
//
// Returns the length of the command list.
int Rhd2000Registers::createCommandListTempSensor(vector<uint16_t> &commandList)
{
    int i;
    ...
    commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 33));     // sample AuxIn2
    commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 34));     // sample AuxIn3
    commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 49));     // sample Temperature Sensor  //result A
    ...
    commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 33));     // sample AuxIn2
    commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 34));     // sample AuxIn3
    commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 49));     // sample Temperature Sensor   //result B
...
//
// Returns the length of the command list.
int Rhd2000Registers::createCommandListUpdateDigOut(vector<uint16_t> &commandList)
{
    int i;
...
// Returns the length of the command list.
int Rhd2000Registers::createCommandListZcheckDac(vector<uint16_t> &commandList, double frequency, double amplitude)
{
    int i, period, value;
    double t;
    const double Pi = 2*acos(0.0);
...
int Rhd2000Registers::createCommandListConvert(vector<uint16_t> &commandList)
{
    commandList.clear();    // if command list already exists, erase it and start a new one
        ...
        commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 0));
        commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 1));
        commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 2));
        commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 3));
        commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 4));
        commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 5));
        commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 6));
        commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 7));
        commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 8));
        commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 9));
        commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 10));
        commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 11));
        commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 12));
        ...
        commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 17));
        commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 18));
        commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 19));
        commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 20));
        commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 21));
        commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 22));
        commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 23));
        commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 24));
        commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 25));
        commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 26));
        commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 27));
        commandList.push_back(createRhd2000Command(Rhd2000CommandConvert, 28));
...
// Create a list of dummy commands for the RHD2000 chip to read sampling rate setting and temperature.
int Rhd2000Registers::createCommandListDummy(vector <uint16_t> &commandList)
{
    commandList.clear();

    commandList.push_back(createRhd2000Command(Rhd2000CommandRegRead, 1));  // supply voltage sensor and ADC buffer bias [5:0]
    commandList.push_back(createRhd2000Command(Rhd2000CommandRegRead, 2));  // MUX bias [5:0]
    commandList.push_back(createRhd2000Command(Rhd2000CommandRegRead, 1));  // repeat for spi delay of two commands
    commandList.push_back(createRhd2000Command(Rhd2000CommandRegRead, 2));
...
// Create a list of dummy commands for the RHD2000 chip.
// Returns the length of the command list.
int Rhd2000Registers::createCommandListDummy(vector <uint16_t> &commandList, int n)
{
    commandList.clear();
...
// Create a list of dummy commands for the RHD2000 chip with a specific command.
// Returns the length of the command list (which should be n).
int Rhd2000Registers::createCommandListDummy(vector <uint16_t> &commandList, int n, unsigned int cmd)
{
    commandList.clear();
...
// reorder the bits for spi transfer -- 16 bits
int Rhd2000Registers::orderEndianCommandList(vector<uint16_t> &commandList)
{
    vector<uint16_t> endianCommandList;
    int commandLength = commandList.size();
    
    for(int i = 0; i < commandLength; i++)
    {
      uint16_t  cmd = commandList[i];
      cmd = (cmd & 0x00FF) << 8 | (cmd & 0xFF00) >> 8;
      endianCommandList.push_back(cmd);
    }
    
    commandList= endianCommandList;
